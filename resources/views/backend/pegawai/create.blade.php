    ...
    <div class="container"> 
        ...
        <a href="/pegawai" class="btn btn-primary"> 
            < Back</a> 
                ...
                <form action="/pegawai/simpan-data" method="post" class="mx-2"> 
                    @csrf 
                    <div class="form-group mt-3"> 
                        <label for="nama">Nama</label> 
                        <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Pegawai" value=""> 
                    </div> 
                    ...
                    <div class="form-group mt-3"> 
                        ...
                        <input type="text" class="form-control" name="kontak" placeholder="Masukkan No Kontak" value=""> 
                    </div> 
